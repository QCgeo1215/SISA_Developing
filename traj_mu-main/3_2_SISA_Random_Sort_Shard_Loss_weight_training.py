...
def main():
    ...
    try:
        ...
        Loss_model_training(
            ...
            model_A_path=full_path +'/3_1_SISA_Random_lstm/SISA_final_model',
            model_B_path=full_path +'/3_1_SISA_Random_lstm/shard_loss_model'
        )
        print("Loss Model training completed.")
    except ValueError as e:
        print(f"错误: {e}")

    time_info_txt = full_path +'/3_1_SISA_Random_lstm/SISA_Sub_model_Loss_training_time.txt'
    # 记录结束时间
    end_time = time.time()
